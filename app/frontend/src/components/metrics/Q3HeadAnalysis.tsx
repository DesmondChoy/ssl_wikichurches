...
export function Q3HeadAnalysis() {
  ...
  const frozenRankingQuery = useHeadRanking(resolvedModel, resolvedLayer, effectivePercentile, metric, 'frozen');
  const loraRankingQuery = useHeadRanking(resolvedModel, resolvedLayer, effectivePercentile, metric, 'lora');
  const fullRankingQuery = useHeadRanking(resolvedModel, resolvedLayer, effectivePercentile, metric, 'full');
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <section className="space-y-4" data-testid="q3-delta-panel">
          <div className="rounded-lg border border-indigo-100 bg-indigo-50 px-4 py-3">
            <div className="text-sm font-medium text-indigo-950">Frozen-to-adapted head delta</div>
            <p className="mt-1 text-sm text-indigo-900">
              Compare how dominant heads move from the frozen baseline into the primary adapted variants for the
              current model, layer, metric, and percentile.
            </p>
            <p className="mt-2 text-xs text-indigo-800" data-testid="q3-delta-helper">
              This delta view always compares Frozen to LoRA and Full. Linear Probe remains a control in the
              single-variant analysis below.
            </p>
          </div>
          ...
          {deltaPanelLoading ? (
            ...
            <div
              ...
              data-testid="q3-delta-unavailable"
            >
            ...
            <div className="grid grid-cols-1 gap-4 2xl:grid-cols-2">
              {deltaComparisons.map((comparison) => (
                <div
                  ...
                  data-testid={`q3-delta-card-${comparison.targetVariant}`}
                >
                  <div className="border-b border-slate-100 px-4 py-3">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span
                        ...
                        data-testid={`q3-delta-summary-${comparison.targetVariant}-promoted`}
                      >
                      ...
                      <span
                        ...
                        data-testid={`q3-delta-summary-${comparison.targetVariant}-demoted`}
                      >
                      ...
                      <span
                        ...
                        data-testid={`q3-delta-summary-${comparison.targetVariant}-stable`}
                      >
                  ...
                  {!comparison.available ? (
                    <div
                      ...
                      data-testid={`q3-delta-card-${comparison.targetVariant}-unavailable`}
                    >
                      {comparison.reason}
                    </div>
                  ) : (
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-slate-100">
                          {comparison.rows.map((row) => (
                            <tr
                              key={row.head}
                              data-testid={`q3-delta-row-${comparison.targetVariant}-${row.head}`}
                            >
